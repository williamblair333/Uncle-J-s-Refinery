# ══════════════════════════════════════════════════════════════════════════
#  VENDORED FILE — DO NOT EDIT.  Local changes are destroyed on re-vendor.
#
...
#  Repo HEAD: be38ccc35e8ec39c3db3f420023fcdae1527cb79  at vendor time
#  License  : MIT — Copyright (c) 2026 Guillaume Meyer and contributors
#  Vendored : 2026-09-01
#
#  Body below is verbatim: `tail -n +13 this-file` == the upstream file.
# ══════════════════════════════════════════════════════════════════════════
